...
if re.search(r"\bexecute\s+immediate\b", sql) or re.search(r"\bsp_executesql\b", sql):
    end_fail("Dynamic SQL constructs detected (execute immediate / sp_executesql). Disallowed by policy.")
end_ok("No dynamic SQL constructs detected.")
