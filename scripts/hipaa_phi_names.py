...
phi_keywords = ["patient","patient_id","member_id","mrn","medical_record","medical_record_number","diagnosis","icd","icd10","icd_10","icd9","procedure_code","cpt","provider","npi","encounter","admission","discharge","prescription","rx","medication","ndc","lab","lab_result","test_result","dob","date_of_birth","insurance","payer","claim"]
violations = []
...
if violations:
    ...
    end_fail(f"Potential HIPAA PHI-related identifiers detected: {details}{more}")
else:
    end_ok("No obvious HIPAA/PHI-like identifiers detected.")
